...
impl Key {
    ...
    pub fn generate_aes_key_for_secret_exchange(private_key: &Self, server_public_key: &Self) -> Self {
        Self::new(crypto::generate_aes_key_for_secret_exchange(private_key, server_public_key).to_vec())
    }
}
